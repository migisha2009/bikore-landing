    ...
    <div className="hidden md:block fixed bottom-8 right-8 z-50">
      <AnimatePresence>
        {isExpanded ? (
          ...
          <motion.div
            ...
            className="w-[260px] bg-[#0D2B1A] border border-[rgba(255,255,255,0.12)] rounded-[24px] p-6 shadow-[0_24px_60px_rgba(0,0,0,0.5)]"
          >
            {/* Header */}
            <div className="flex justify-between items-start mb-4">
              <div>
                ...
                <p className="text-[#B8E08D] text-[12px] mt-0.5">
                  Scan with your phone camera
                </p>
              </div>
              <button
                onClick={() => setIsExpanded(false)}
                className="w-7 h-7 rounded-full bg-[rgba(255,255,255,0.1)] text-white text-base hover:bg-[rgba(255,255,255,0.2)] transition-colors flex items-center justify-center"
              >
                ×
              </button>
            </div>
            ...
            {/* Divider */}
            <div className="border-t border-[rgba(255,255,255,0.08] my-4"></div>

            {/* Store Badges */}
            <div className="flex gap-2 justify-center">
              {/* App Store Badge */}
              <button className="flex-1 bg-[rgba(255,255,255,0.08)] border border-[rgba(255,255,255,0.12)] rounded-[10px] p-2 flex items-center gap-1.5 hover:bg-[rgba(255,255,255,0.14)] transition-colors cursor-pointer">
            ...
            {/* Footer */}
            <p className="text-center mt-3 text-[11px]" style={{ color: 'rgba(255,255,255,0.35)' }}>
          ...
          >
            ...
            <AnimatePresence>
              {showTooltip && (
                <motion.div
                  ...
                  className="absolute bottom-[calc(100%+8px)] right-0 bg-[rgba(0,0,0,0.8)] text-white text-[11px] rounded-[6px] px-2 py-1 whitespace-nowrap"
                >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="bg-[#1A4D2E] border border-[rgba(255,255,255,0.15)] rounded-[999px] px-[18px] py-[10px] flex items-center gap-[10px] cursor-pointer shadow-[0_8px_32px_rgba(0,0,0,0.3)]"
              style={{
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-[#B8E08D] text-[11px] leading-tight">
                  Free on iOS & Android
                </div>
              </div>
            </motion.button>
      ...
      <style jsx>{`
        @keyframes glowPulse {
          ...
          50% { 
            box-shadow: 0 8px 32px rgba(45,122,58,0.5), 0 0 0 4px rgba(45,122,58,0.15) 
          }
        }
      `}</style>
    </div>
